...
namespace SampleCsCommands
{
  ...
  public class SampleCsCustomLineObject : Rhino.DocObjects.Custom.CustomCurveObject
  {
    ...
    {
      System.Drawing.Color color = Attributes.DrawColor(e.RhinoDoc);
      e.Display.DrawPoint(CurveGeometry.PointAtStart, color);
      if (!CurveGeometry.IsClosed)
        e.Display.DrawPoint(CurveGeometry.PointAtEnd, color);
      base.OnDraw(e);
    }
  }

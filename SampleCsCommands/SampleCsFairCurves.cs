...
namespace SampleCsCommands
{
  public class SampleCsFairCurves : Command
  {
    ...
    private double m_dist_tol = 1.0;
    private readonly double m_ang_tol = 0.05;
    private readonly int m_iterations = 20; // Use 20 iterations as part of getting Fair to stay within stated tolerance

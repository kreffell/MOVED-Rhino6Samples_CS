...
namespace Project
{
    ...
    public class SectionTwo : Section
    {
        ...
        ///<summary>
        /// EnglishCaption is the english caption.
        ///</summary>
        public override string EnglishCaption { get { return "Section two"; } }
        ///<summary>
        /// LocalCaption is the localized caption to display in the section header.
        ///</summary>
        public override string LocalCaption { get { return "Section two"; } }
